...
function fetchRatings($id, $conn)
{
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<p class='text-red-600'>No feedback entries found for this user.</p>";
    }
}
    ...
    <div class="container mx-auto max-w-md mt-10">
        <form method="post" class="bg-slate-800 shadow-md rounded-md p-6 mb-4">
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" id="rating" name="rating" type="number" placeholder="Enter rating" required>
            </div>
            <div class="mb-6">
